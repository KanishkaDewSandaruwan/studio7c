    ...
    <?php include 'common/top.php'; ?>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <a style="float: left; margin-right: 10%;" href="package.php"><h2 class="text-success">Create Package  </h2>
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table v-middle" style="text-align: center;">
                                    <thead>
                                        <tr class="bg-dark">
                                            <th class="border-top-0 text-white">Package Name</th>
                                            <th class="border-top-0 text-white">Package Details</th>
                                            <th class="border-top-0 text-white">Service</th>
                                            <th class="border-top-0 text-white">Price</th>
                                            <th class="border-top-0 text-white">Availability</th>
                                            <th class="border-top-0 text-white">Date</th>
                                            <th class="border-top-0 text-white">Quick Edit</th>
                                        ...
                                        <tbody>
                                          <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-b-0"><?php echo $row['price']; ?></h5>
                                                </td>
                                                <td><h5 class="m-b-0"><?php echo $row['availability']; ?></h5></td>
                                                <td><?php echo $row['trndate']; ?></td>
                                                <td style="text-align: center;"><a style="text-decoration: none; color: red; font-size: 25px;" href="edit.php?quick_pack_id=<?php echo $row['pack_id']; ?>"><i class="fas fa-user-edit"></i></a></td>
                                                <td style="text-align: center;"><a style="text-decoration: none; color: red; font-size: 25px;" href="edit.php?pack_id=<?php echo $row['pack_id']; ?>"><i class="fas fa-edit"></i></a></td>
                                                <td style="text-align: center;"><a style="text-decoration: none; color: red; font-size: 25px;" href="delete.php?pack_id=<?php echo $row['pack_id']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                                            </tr>
                                            <?php   $count++;  }?>
                                    </tbody>
                                </table>
