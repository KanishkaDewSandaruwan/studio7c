          ...
          <div class="row">
            ...
            <!-- ...................Content Here...................... -->
             <form method="post" action="" style="padding: 3%;" enctype='multipart/form-data'>
                    ...
                    <input class="btn btn-danger col-sm-5" type='submit' value='Change' name='but_upload'><br><br>

                    <button type="button" onclick="window.location.href='custom.php'" name="button" class="btn col-xl-10 btn-danger">Back to Slide Manager</button><br><br>
                  </form>
                   ...
                   if(isset($_POST['but_upload'])){
                    ...
                    $desc3 = $_REQUEST['desc3'];
                      ...
                      if(!empty($title1))
                      {
                        ...
                        $query3="UPDATE slider_banner SET title1='$title1'";
                      ...
                      if(!empty($desc1))
                      {
                        ...
                        $query3="UPDATE slider_banner SET description1='$desc1'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Slide Show Image Change Success"); window.location.href="custom.php";</script>';
                      }
                      if(!empty($title2))
                      {
                        ...
                        $query3="UPDATE slider_banner SET title2='$title2'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Slide Show Image Change Success"); window.location.href="custom.php";</script>';
                      }
                      if(!empty($desc2))
                      {
                        ...
                        $query3="UPDATE slider_banner SET description2='$desc2'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Slide Show Image Change Success"); window.location.href="custom.php";</script>';
                      }
                      if(!empty($title3))
                      {
                        ...
                        $query3="UPDATE slider_banner SET title3='$title3'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Slide Show Image Change Success"); window.location.href="custom.php";</script>';
                      }
                      if(!empty($desc3))
                      {
                        ...
                        $query3="UPDATE slider_banner SET description3='$desc3'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Slide Show Image Change Success"); window.location.href="custom.php";</script>';
                      }
                    }
