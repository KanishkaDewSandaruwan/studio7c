                                          ...
                                          <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                            if ($row['complete'] == 'Completed') {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><a style="text-decoration: none; color: red; font-size: 30px;" href="booking_change.php?complete_delete=<?php echo $row['bid']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                                                </tr>
                                            <?php   $count++;  } }?>
                                    </tbody>
                                </table>
