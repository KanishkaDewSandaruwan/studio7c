                                ...
                                <table class="table v-middle" style="text-align: center;">
                                    <thead>
                                        <tr class="bg-dark">
                                            ...
                                            <th class="border-top-0 text-white">Delete</th>
                                        </tr>
                                    </thead>
                                    <?php 
                                      $count=1;
                                          ...
                                          <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                            if ($row['complete'] == 'Reject') {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><a style="text-decoration: none; color: red; font-size: 30px;" href="booking_change.php?reject_delete=<?php echo $row['bid']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                                                </tr>
                                            <?php   $count++;  } }?>
                                    </tbody>
                                </table>
