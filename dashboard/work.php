                  ...
                  <a href="view_work.php"><h2 class="text-success">View Your Work  </h2> </br></a><br>
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                        <label for="title" class="text-dark"><b>Title</b></label><br>
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                        <label for="highlight" class="text-dark"><b>Highlight</b></label><br>
                                        <input type="text" class="form-control" name="highlight" placeholder="HighLlight">
                                      </div>
                                    </div><br><br>
                                    ...
                                    <textarea id="summernote" name="editordata"></textarea>
                                      ...
                                      <p style="font-size: 20px; color: green">Main Image</p>
                                      <input type='file' name='file' /><br><br>

                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                      <label class="text-dark" for="original_price"><b>Worked date</b></label><br>
                            ...
                            <div class="dropdown-divider"></div>
                                ...
                                <button type="submit" name="submit" class="btn col-xl-12 btn-danger" style="border-radius:20px;">Save Work</button><br><br>
                              </div>
                   </div>
                                    <?php
                                                  ...
                                                  if(!empty($bday)){
                                                    ...
                                                    if( in_array($imageFileType,$extensions_arr) ){
                                                            ...
                                                            $sid = $row2['sid'];
                                                                        ...
                                                                        $q1="INSERT INTO work(title,highlight,description,head_image,worked_date,trndate,service) values('$title','$highlight','$editordata','$name','$bday','$cdate','$sid')";

                                                                            $res =  mysqli_query($con,$q1);
                                                                          if ($res) {
                                                                            move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name);
                                                                            echo "<script type=\"text/javascript\"> alert(\"Work Created Succussfully\"); window.location= \"work.php\";</script>";
                                                                          }else{
                                                                            echo "<script>alert(\"Work Creating is Not Scussess\");</script>";
                                                                          }
                                                                    
                                                          }else{ echo "<script>alert(\"You cantupload this Image format\");</script>";}
                                                          }else{ echo "<script>alert(\"Please Upload Head Image\");</script>";}

                                                      }else{ echo "<script>alert(\"Please Enter Date\");</script>";}
                                                    }else{ echo "<script>alert(\"Please Select Service\");</script>";}
                                                  }else{ echo "<script>alert(\"Please Enter Description as you wish\");</script>";}
                                                }else{ echo "<script>alert(\"Please Enter Highlight\");</script>";}
                                              }else{echo "<script>alert(\"Please Enter Tile\");</script>";}
                                        }
