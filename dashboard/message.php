                                ...
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-dark">
                                            ...
                                            <th class="border-top-0 text-white">Message Read</th>
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_assoc($viewresult)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['msg_read']; ?></td>
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?m_id=<?php echo $row['m_id']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                                        </tr>
                                        <?php   $count++; } ?>
                                    </tbody>
                                </table>
