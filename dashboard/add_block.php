        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <form class="col-md-10" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <p style="font-size: 20px; color: green">Detail Box 01</p>
                    ...
                    <p style="font-size: 20px; color: green">Detail Box 03</p>
                    ...
                    <p style="font-size: 20px; color: green">Detail Box 04</p>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="name" class="a"><b>Description</b></label>
                        <input type="text" class="form-control" name="desc4" placeholder="Description">
                      </div>
                    </div>
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="submit" name="submit" class="btn col-xl-10 btn-info" style="border-radius:20px;">Save About Details</button>
                   <button type="button" name="submit" onclick="window.location.href='custom.php'" class="btn col-xl-10 btn-info" style="border-radius:20px;">Go Back</button>
                   </div>
                   </div>
                   ...
                   if(isset($_POST['submit'])){
                    ...
                    $viewquery = " SELECT * FROM details_block";
                    $viewresult = mysqli_query($con,$viewquery);

                    if(mysqli_num_rows($viewresult)>0){
                        echo '<script>alert("Detail Block Alrady Addedd. You can Only Change Image"); window.location.href="custom.php";</script>';
                    }else{
                                          ...
                                          if (!empty($desc3)) {
                                            if (!empty($title4)) {
                                              if (!empty($desc4)) {
                                               ...
                                               $query = "INSERT into details_block(image1,title1,description1,image2,title2,description2,image3,title3,description3,image4,title4,description4) values('".$name."','$title1','$desc1','".$name1."','$title2','$desc2','".$name2."','$title3','$desc3','".$name3."','$title4','$desc4')";
                                            ...
                                            echo '<script>alert("Details box Inserted Success"); window.location.href="add_block.php";</script>';


                                            }else{echo "<script>alert(\"Enter Description 04\");</script>";}
                                          }else{echo "<script>alert(\"Enter Title 04\");</script>";}
