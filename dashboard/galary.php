      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <form class="col-md-10 ml-5" action="" method="POST" enctype="multipart/form-data">
                    <h2 class="text-info">Create Galary</h2> </br>
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="submit" name="submit" class="btn col-xl-10 btn-danger" style="border-radius:20px;">Add to Galary</button>
                   </div>
                   </div>
                                    <?php
                                        ...
                                        if(isset($_FILES['file']) && !empty($_FILES['file']['name'])) { 
                                              ...
                                              $extensions_arr = array("jpg","jpeg","png","gif","mkv","mp4");
                                                      ...
                                                      if (in_array($imageFileType,$extensions_arr)) {
                                                              ...
                                                              $q1="INSERT INTO gallery(service,image) values('$sid','$name')";
                                                                    $res1=mysqli_query($con,$q1);
                                                                    if ( $res1)
                                                                    {

                                                                         echo '<script>alert("Image adding to Gallery is Scussessfully.");window.location.href="galary.php"; </script>';
                                                                    }else{
                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                        ...
                                        $q4 = "SELECT * FROM service WHERE sid='$sid'";
                                        $res4 = mysqli_query($con,$q4);
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?img_id=<?php echo $row['img_id']; ?>"><i style="font-size: 30px;" class="fas fa-trash-alt"></i></a></td>
                                        </tr>
                                        <?php   $count++;  }?>
                                    </tbody>
                                </table>
