                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table v-middle" style="text-align: center;">
                                    ...
                                    <?php 
                                      $count=1;
                                        $viewquery = " SELECT * FROM booking order by trndate";
                                        $viewresult = mysqli_query($con,$viewquery);
                                    
                                         ?>
                                        <tbody>
                                          <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                            if ($row['complete'] == 'Pending') {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><a style="text-decoration: none; color: red; font-size: 30px;" href="booking_change.php?accept_bid=<?php echo $row['bid']; ?>"><i class="fas fa-calendar-check"></i></a></td>
                                                </tr>
                                            <?php   $count++;  } }?>
                                    </tbody>
                                </table>
